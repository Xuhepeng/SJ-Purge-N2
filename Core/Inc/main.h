...
#define vacuum_open() HAL_GPIO_WritePin(o_vacuum_pin_GPIO_Port, o_vacuum_pin_Pin, GPIO_PIN_SET)
#define vacuum_close() HAL_GPIO_WritePin(o_vacuum_pin_GPIO_Port, o_vacuum_pin_Pin, GPIO_PIN_RESET)
...
#define relay_on() HAL_GPIO_WritePin(o_relay_pin_GPIO_Port, o_relay_pin_Pin, GPIO_PIN_RESET)
#define relay_off() HAL_GPIO_WritePin(o_relay_pin_GPIO_Port, o_relay_pin_Pin, GPIO_PIN_SET)
#define py_relay_on() HAL_GPIO_WritePin(o_py_relay_pin_GPIO_Port, o_py_relay_pin_Pin, GPIO_PIN_SET)
#define py_relay_off() HAL_GPIO_WritePin(o_py_relay_pin_GPIO_Port, o_py_relay_pin_Pin, GPIO_PIN_RESET)
